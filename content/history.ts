...
export type Milestone = {
  ...
  title: string;
  text: string;
  image: { src: string; alt: string }; // src "" = placeholder
};
...
export const milestones: Milestone[] = [
  {
    ...
    image: { src: "", alt: "Early HADE gathering, 2018" },
  },
  {
    year: "2019",
    ...
    image: { src: "", alt: "Community event, 2019" },
  },
  {
    year: "2020",
    ...
    image: { src: "", alt: "The founding team, 2020" },
  },
  {
    year: "2021",
    ...
    image: { src: "", alt: "Celebrating nonprofit status, 2021" },
  },
  {
    year: "Today",
    ...
    image: { src: "", alt: "The HADE community today" },
  },
];
